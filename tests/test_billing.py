def test_create_dealer_audit(login_page, billing_page, credentials):
    login_page.navigate_to_login_cars()
    login_page.do_login_car(credentials)
...
def test_search_invoices(login_page, billing_page, credentials):
    login_page.navigate_to_login_cars()
    login_page.do_login_car(credentials)
...
def test_search_payroll(login_page, billing_page, credentials):
    login_page.navigate_to_login_cars()
    login_page.do_login_car(credentials)
...
def test_memo(login_page, billing_page, credentials):
    login_page.navigate_to_login_cars()
    login_page.do_login_car(credentials)
...
def test_approvalPage_memo(login_page, billing_page, credentials):
    login_page.navigate_to_login_cars()
    login_page.do_login_car(credentials)
